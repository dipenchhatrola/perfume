...
export default function Orders() {
  ...
  const fetchAdminOrders = async () => {
    ...
    try {
      ...
      // Fallback to dummy data if no orders found
      const dummyOrders = [
        {
          id: '1',
          orderId: 'ORD-001',
          ...
          date: 'Jan 15, 2024',
          items: [
            { productId: '1', name: 'Premium Perfume', price: 999, quantity: 2, image: 'https://via.placeholder.com/100' },
            { productId: '2', name: 'Luxury Cologne', price: 1999, quantity: 1, image: 'https://via.placeholder.com/100' }
          ],
        ...
        },
        {
          ...
          date: 'Jan 14, 2024',
          items: [
            { productId: '3', name: 'Floral Perfume', price: 1499, quantity: 1, image: 'https://via.placeholder.com/100' }
          ],
        ...
        },
        {
          ...
          date: 'Jan 16, 2024',
          items: [
            { productId: '4', name: 'Premium Cologne', price: 2499, quantity: 1, image: 'https://via.placeholder.com/100' },
            { productId: '5', name: 'Mini Perfume', price: 1000, quantity: 1, image: 'https://via.placeholder.com/100' }
          ],
      ...
      setStats(calculateStats(dummyOrders));
    } finally {
      setLoading(false);
